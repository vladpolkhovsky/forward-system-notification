...
public class NotificationDispatcher {
    ...
    public void dispatchAll(SendNotificationMessageDto messageDto) {
        ...
        if (notificationBot.getTgChatId() != null) send(TargetMessengerType.TELEGRAM, messageDto.withMessenger(TargetMessengerType.TELEGRAM));
        if (notificationBot.getMaxChatId() != null) send(TargetMessengerType.MAX, messageDto.withMessenger(TargetMessengerType.TELEGRAM));
        if (notificationBot.getVkChatId() != null) send(TargetMessengerType.VK, messageDto.withMessenger(TargetMessengerType.TELEGRAM));
